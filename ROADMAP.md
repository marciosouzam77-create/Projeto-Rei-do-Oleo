...
| **Histórico do veículo** | Linha do tempo de todos os serviços realizados no veículo (visível na aba de veículos). |
...
| Item | Descrição |
|---|---|
| ✅ **Catálogo de serviços** | Tabela configurável com os serviços oferecidos pela oficina (ex: Troca de óleo, Alinhamento, Balanceamento, Troca de filtro, Revisão de freios), com preço base, categoria e tempo estimado. |
...
| ✅ **Atualização automática do veículo** | Check-out atualiza o KM atual do veículo automaticamente. |
...
| **Tempo médio por mecânico** | Relatório de tempo médio de atendimento por mecânico para avaliação de desempenho. |
| **OS por mecânico** | Quantidade de ordens de serviço concluídas por mecânico no período. |
...
Em andamento →  Fase 2: orçamentos, fotos, assinatura digital, impressão de OS
Curto prazo  →  Fase 3: automação de lembretes WhatsApp
Médio prazo  →  Fase 4: gestão financeira e relatórios por mecânico
